...
clearvars obj_GADMM loss_GADMM Iter_gadmm feas_gadmm...
    obj_2GADMM loss_2GADMM Iter_2GADMM cumulative_com_2GADMM feas_2gadmm...
    cumulative_EnergyCost_gadmm cumulative_EnergyCost_qgadmm cumulative_com_GADMM
end
...
legend('GADMM-\rho=10', 'Q-GADMM-3bits-\rho=10',...
    'GADMM-\rho=20', 'Q-GADMM-3bits-\rho=20'...
    ,'GADMM-\rho=30', 'Q-GADMM-3bits-\rho=30');
